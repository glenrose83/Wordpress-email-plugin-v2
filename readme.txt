...
Install using Wordpress backend. Select "Plugins" -> "Add plugin" -> "Upload plugin" -> "Choose file" and "Install Now".

Remember to activate it and have fun!



== Installation ==

1. Backend setting up a form
2. Backend emailist actions
3. Frontend look
4. ReadMe
